...
params = {'x_dim': 3, 'enc_hidden_channels': 128, 'z_dim': 64, 'num_enc_hidden_layers': 4,
...
# train model
fig_dir = '/afs/crc.nd.edu/user/c/coballe/graphvaes/figs/tuning_architectures/13/'
...
os.chdir(model_dir)
torch.save(mod.state_dict(), 'mod_128_64_silu_tanh.pth')
