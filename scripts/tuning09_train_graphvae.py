...
params = {'x_dim': 3, 'enc_hidden_channels': 256, 'z_dim': 32, 'num_enc_hidden_layers': 4,
                 'dec_hidden_channels': 256, 'num_dec_hidden_layers': 4, 'adjacency': adjacency, 'output_dists': False,
...
# train model
fig_dir = '/afs/crc.nd.edu/user/c/coballe/graphvaes/figs/tuning_architectures/09/'
...
os.chdir(model_dir)
torch.save(mod.state_dict(), 'mod_256_32_silu_tanh.pth')
