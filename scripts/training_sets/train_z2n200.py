...
params = {'x_dim': 3, 'enc_hidden_channels': 128, 'z_dim': 2, 'num_enc_hidden_layers': 4,
...
os.chdir(model_dir)
torch.save(mod.state_dict(), 'mod_z2n200.pth')