...
# train model
fig_dir = '/afs/crc.nd.edu/user/c/coballe/graphvaes/figs/noreg/z8/'
model_dir = '/afs/crc.nd.edu/user/c/coballe/graphvaes/models/noreg/'
os.chdir(fig_dir)
...
os.chdir(model_dir)
torch.save(mod.state_dict(), 'mod_z8_noreg.pth')