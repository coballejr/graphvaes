...
params = {'x_dim': 3, 'enc_hidden_channels': 128, 'z_dim': 8, 'num_enc_hidden_layers': 4,
...
# train model
fig_dir = '/afs/crc.nd.edu/user/c/coballe/graphvaes/figs/training_sets/z8n100/'
model_dir = '/afs/crc.nd.edu/user/c/coballe/graphvaes/models/training_sets/'
os.chdir(fig_dir)

epochs, batch_size, cutoff, n_atoms = 8000, 64, 0.5, 22
subset_size, train_prop  = 100, 1.0
...
os.chdir(model_dir)
torch.save(mod.state_dict(), 'mod_z8n100.pth')